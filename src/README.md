...
```bash
ace-integration-framework$ sam build --use-container
```
...
```bash
ace-integration-framework$ sam logs -n StockCheckerFunction --stack-name ace-integration-framework --tail
```
...
```bash
ace-integration-framework$ pip install pytest pytest-mock --user
ace-integration-framework$ python -m pytest tests/ -v
```
...
```bash
aws cloudformation delete-stack --stack-name ace-integration-framework
```
